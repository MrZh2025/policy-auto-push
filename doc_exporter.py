...
def set_para_spacing(p, line_spacing_pt=Pt(28.5), space_before_pt=Pt(0), space_after_pt=Pt(0), align=WD_ALIGN_PARAGRAPH.JUSTIFY, first_line_indent_pt=Pt(32)):
    """设置段落固定行距 28.5 磅、首行缩进 2 字符与对齐"""
